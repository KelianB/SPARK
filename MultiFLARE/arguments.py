...
def config_parser():
    ...
    parser.add_argument("--material_input", type=str, default="canonical_pos", choices=(["canonical_pos", "flame_pos", "uvs"]), help="Which inputs to use for the material MLP (canonical mesh with displacements, FLAME template mesh or UVs)")
    ...
    parser.add_argument("--deformer_input", type=str, default="canonical_pos", choices=(["canonical_pos", "uvs"]), help="Which inputs to use for the deformer MLP (canonical mesh with displacements or UVs)")
